...
function setup() {
  ...
  mini.addImage(man);
  mini.scale = 0.14;
  piso1=createSprite(530,878,1000,1)
  piso2=createSprite(240,810,470,1);
  piso3=createSprite(1590,878,670,1);
  piso4=createSprite(1780,813,330,1);
  piso5=createSprite(131,713,260,10);
  piso6=createSprite(811,613,100,10);
  piso7=createSprite(670,683,164,10);
  piso8=createSprite(955,678,49,10);
  piso9=createSprite(895,578,90,10);
  piso10=createSprite(1295,578,90,10);
  piso11=createSprite(1466,614,270,10);
  piso12=createSprite(1052,842,49,10);
  piso13=createSprite(1115,780,79,10);
  piso14=createSprite(1198,815,79,10);
  piso15=createSprite(1698,715,79,12);
  piso16=createSprite(1833,680,177,12);
  // piso1.visible = false;
  // piso2.visible = false;
  // piso3.visible = false;
  // piso4.visible = false;
